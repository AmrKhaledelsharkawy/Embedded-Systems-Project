...
nav {
        ...
        /* Content styling for the second page */
        .gallery {
            display: flex;
            flex-wrap: wrap;
...
<body>
  <nav>
      <a  onclick="showAcceleratePage()">Accelerate</a>
      <a  onclick="showGalleryPage()">Gallery</a>
  </nav>

  <!-- Accelerate Page -->
  <div id="acceleratePage">
      <div id="startForm">
  ...
  <div id="galleryPage" style="display:none;">
      <div class="gallery">
          <!-- Add your image labels and names here -->
          <img src="https://i.imgur.com/pE1XCUn.jpg" alt="Label 1" title="Name 1">
          
          <img src="https://i.imgur.com/fRkIyFy.jpg" alt="Label 2" title="Name 2">
          ...
          <img src="https://i.imgur.com/gw6kRDG.jpg" alt="Label 2" title="Name 2">
          <img src="https://i.imgur.com/84LXypX.jpg" alt="Label 2" title="Name 2">
...
function showAcceleratePage() {
 document.getElementById('acceleratePage').style.display = 'block';
 document.getElementById('galleryPage').style.display = 'none';
 }

function showGalleryPage() {
    document.getElementById('acceleratePage').style.display = 'none';
...
def handle_request(client_socket):
    ...
    if request_method == "POST":
        ...
        printLCD("Okay Write Your Name and Play!")
        client_socket.send(response.encode('utf-8'))
...
def website(state1):
    ...
    try:
        while True:
            ...
            if get_button() == 1:
                printLCD("Button Pressed website")
                state1 +=1
                utime.sleep(1.5)
                return state1       
