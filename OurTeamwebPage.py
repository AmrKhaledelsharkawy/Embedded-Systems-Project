...
<body>
    ...
    <div class="team">
        <center>
            <hr>
            <!-- DMET Students Section -->
            <h2>THE DMET STUDENTS</h2>
            <div class="row">
                <div class="column" id="gfg">
                    <div class="card">
						<i class="fa fa-user-circle" style="font-size:68px;"></i>
                            <img class="" src="https://i.imgur.com/gw6kRDG.jpg" alt="Label 1" title="Name 1">
					</i>
                        <div class="container">
                            <h2>Amr </h2>
                            <p>github</p>
                            <p>
								https://github.com/AmrKhaledelsharkawy
                            </p>
                ...
                <div class="column" class="dmet">
                    <div class="card">
                        <i class="fa fa-user-circle" style="font-size:68px;">
                            <img src="https://i.imgur.com/OayO1dq.jpg" alt="Label 2" title="Name 2">
                        </i>
                        <div class="container">
                            <h2>Yara </h2>
                            <p>github</p>
                            <p>
                                https://github.com/yaraeslamm
                            </p>
                            <button class="button">View</button>
                        </div>
                    </div>
            ...
            <!-- CSEN Students Section -->
            <h2>THE CSEN STUDENTS</h2>
			<div class="column">
				<div class="card">
					<i class="fa fa-user-circle" style="font-size:68px;">
						<img src="https://i.imgur.com/2lpLZYU.jpg" alt="Label 2" title="Name 2">
					</i>
					<div class="container">
						<h2>Youssef</h2>
						<p>github</p>
						<p>
							https://github.com/youssefamr367
						</p>
						<button class="button">View</button>
					</div>
				</div>
            ...
            <div class="row">
                <div class="column">
                    <div class="card">
                        <i class="fa fa-user-circle" style="font-size:68px;">
                            <img src="https://i.imgur.com/pE1XCUn.jpg" alt="Label 2" title="Name 2">
                        </i>
                        <div class="container">
                            <h2>Ahmed</h2>
                            <p>github</p>
                            <p>
								https://github.com/ahzsalah
                            </p>
                            <button class="button">View</button>
                        </div>
                    </div>
				...
				<div class="column">
                    <div class="card">
                        <i class="fa fa-user-circle" style="font-size:68px;">
                            <img src="https://i.imgur.com/ceQMyl9.png" alt="Label 2" title="Name 2">
                        </i>
                        <div class="container">
                            <h2>Ibrahim</h2>
                            <p>github</p>
                            <p>
                                https://github.com/ibrahimaboras
                            </p>
                            <button class="button">View</button>
                        </div>
                    </div>
				...
				<div class="column">
                    <div class="card">
                        <i class="fa fa-user-circle" style="font-size:68px;">
                            <img src="https://i.imgur.com/biZoHp4.png" alt="Label 2" title="Name 2">
                        </i>
                        <div class="container">
                            <h2>Yaseen</h2>
                            <p>github</p>
                            <p>
								https://github.com/yaseenriad                            </p>
                            <button class="button">View</button>
                        </div>
                    </div>
                </div>
                            <h2>Our Main Supporters</h2>
                             </div>
				<div class="column">
                    <div class="card">
                        <i class="fa fa-user-circle" style="font-size:68px;">
                            <img src="https://i.imgur.com/Ml07xAT.jpg" alt="Label 2" title="Name 2">
                        </i>
                        <div class="container">
                            <h2>Khaled</h2>
                            <p>github</p>
